...
$(document).ready(function () {
    ...
    /* ---------- Class added by M3 -------- Begin --------*/
    var swiperFull = new Swiper('.swiper-full-screen-02', {
        loop: true,
        slidesPerView: 1,
        preventClicks: false,
        allowTouchMove: true,
    ...
    var swiperFull = new Swiper('.swiper-full-screen-03', {
        loop: true,
        slidesPerView: 1,
        preventClicks: false,
        allowTouchMove: true,
    ...
    /* ---------- Class added by M3 -------- End --------*/


    var swiperFull = new Swiper('.swiper-portfolio-01', {
        loop: true,
        slidesPerView: 1,
        preventClicks: false,
        allowTouchMove: true,
    ...
    var swiperFull = new Swiper('.swiper-portfolio-02', {
        loop: true,
        slidesPerView: 1,
        preventClicks: false,
        allowTouchMove: true,
...
/* -------- Added by Michelle ----- This one has autoplay disabled ---- Begin ------- */

    var swiperBlog = new Swiper('.swiper-carousel-01', {
        allowTouchMove: true,
        slidesPerView: "auto",
        centeredSlides: true,
        spaceBetween: 15,
...
/* -------- Added by Michelle ----- This one has autoplay disabled ---- End ------- */
    ...
    /* ------- Added by M3 -------- Begin -------- */
    $('.unique-lightbox-gallery-01').magnificPopup({
        delegate: 'a',
        type: 'image',
        tLoading: 'Loading image #%curr%...',
        mainClass: 'mfp-fade',
    ...
    $('.unique-lightbox-gallery-02').magnificPopup({
        delegate: 'a',
        type: 'image',
        tLoading: 'Loading image #%curr%...',
        mainClass: 'mfp-fade',
